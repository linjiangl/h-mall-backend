...
const SkuDefault: React.FC<ParamsProps> = () => {
  return (
    <>
      ...
      <FormNumber name={['sku', 'weight']} label="重量" unit="kg" />

      <FormNumber name={['sku', 'volume']} label="体积" unit="m³" />
      ...
      <FormNumber name={['sku', 'stock']} label="库存" unit="件" rules={[{ required: true }]} />

      <FormNumber
        name={['sku', 'stock_alarm']}
        label="库存预警"
        unit="件"
